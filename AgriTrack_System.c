...
// Data Structure: Queue (FIFO - Stores harvested items in inventory)
struct item {
    char name[50];
    int qty;          
    int days;          
...
// Data Structure: Stack (LIFO - Stores dispatched items for undo operations)
struct undo {
    char name[50];
    int qty;
    int days;
...
// Global pointers for Linked List, Queue, and Stack
